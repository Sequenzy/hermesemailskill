...
const required = [
  ...
  "public/skills/hermesemailskill/SKILL.md",
  "public/.well-known/skills/hermesemailskill/SKILL.md",
  "public/.well-known/agent-skills/hermesemailskill/SKILL.md",
...
if (!markdown.includes("npx skills add hermesemailskill")) throw new Error("Missing markdown install shortcut");
...
if (indexJson.skills?.[0]?.name !== "hermesemailskill") throw new Error("Invalid well-known skills index");
